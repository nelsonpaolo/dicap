...
<script type="text/javascript">
    var ajaxUrlLugarAlta = "{{ action('ValidacionesController@getLugarAlta') }}";
</script>

{{ HTML::script('js/lugares/lugar_save.js') }}
        ...
        <div class="col-md-10">
            <div class="jumbotron">
                <div class="container">
                    ...
                    <legend> <strong>Registrar un Nuevo Lugar</strong> </legend>
                    ...
                    <button id="boton" class="btn btn-primary btn-lg">
                        <span class="glyphicon glyphicon-thumbs-up"></span> <strong>Crear Lugar</strong>
                    </button>
