...
<script type="text/javascript">
    var ajaxUrlClienteEdit = "{{ action('ValidacionesController@getClienteEdit') }}";
</script>

{{ HTML::script('js/clientes/cliente_edit.js') }}
        ...
        <div class="col-md-10">
            <div class="jumbotron">
                <div class="container">
                    ...
                    <legend> <strong>Editar datos del Cliente: </strong>{{ $cliente->nombre }} </legend>
