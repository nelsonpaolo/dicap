...
<script type="text/javascript">
    var ajaxUrlProductoAlta = "{{ action('ValidacionesController@getProductoAlta') }}",
        ajaxUrlGetCategorias = "{{ action('ValidacionesController@getCategorias') }}";
</script>

{{ HTML::script('js/productos/producto_save.js') }}
        ...
        <div class="col-md-10">
            <div class="jumbotron">
                <div class="container">
                    ...
                    <legend> <strong>Registrar un Nuevo Producto</strong> </legend>
                    ...
                    <button id="boton" class="btn btn-primary btn-lg">
                        <span class="glyphicon glyphicon-thumbs-up"></span> <strong>Crear Producto</strong>
                    </button>
