...
<script type="text/javascript">
    var ajaxUrlProveedorAlta = "{{ action('ValidacionesController@getProveedorAlta') }}";
</script>

{{ HTML::script('js/proveedores/proveedor_save.js') }}
        ...
        <div class="col-md-10">
            <div class="jumbotron">
                <div class="container">
                    ...
                    <legend> <strong>Registrar un Nuevo Proveedor</strong> </legend>
                    ...
                    <button id="boton" class="btn btn-primary btn-lg">
                        <span class="glyphicon glyphicon-thumbs-up"></span> <strong>Crear Proveedor</strong>
                    </button>
